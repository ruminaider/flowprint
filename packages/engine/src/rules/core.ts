/**
 * Core rules evaluation logic shared between Node.js and browser evaluators.
 *
 * Contains all pure evaluation functions (operators, conditions, hit policies,
 * dot-path resolution) without any platform-specific dependencies.
 */
