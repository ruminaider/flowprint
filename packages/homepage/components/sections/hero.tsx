  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 text-center">
        ...
        {/* Headline */}
        <h1
          className="text-5xl md:text-7xl font-bold tracking-tight mb-6 text-balance animate-fade-in-up"
        ...
        >
          Visual design, decision tables, simulation, code generation, and version control — all in
          one specification that business defines and engineering ships.
        </p>
