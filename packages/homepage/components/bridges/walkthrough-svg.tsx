...
export function WalkthroughSvg({ isActive, wtRipples }: WalkthroughSvgProps) {
  return (
    <svg className={`flow-svg${isActive ? ' active-svg' : ''}`} viewBox="0 0 900 400" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ALL edges */}
      <line data-edge-id="wt-edge-checkin-verify" className="edge" x1="238" y1="63" x2="390" y2="63" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-verify-assess" className="edge" x1="430" y1="78" x2="490" y2="172" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-assess-priority" className="edge" x1="536" y1="187" x2="620" y2="187" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-priority-urgent-v" className="edge" x1="660" y1="202" x2="640" y2="310" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-priority-routine-h" className="edge" x1="700" y1="187" x2="780" y2="187"/>
      <line data-edge-id="wt-edge-priority-routine-v" className="edge" x1="780" y1="187" x2="780" y2="360" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-emergprep-review" className="edge" x1="560" y1="325" x2="350" y2="325" markerEnd="url(#wt-arrow)"/>
      <line data-edge-id="wt-edge-review-end" className="edge" x1="270" y1="325" x2="143" y2="325" markerEnd="url(#wt-arrow)"/>
      <path data-edge-id="wt-edge-sched-end-h" className="edge" d="M737 375 L130 375 L130 338" markerEnd="url(#wt-arrow)"/>
      ...
      {/* ALL nodes */}
      {/* Check In (action) */}
      <g data-node-id="wt-node-checkin" className="node-group ntype-action" data-cx="200" data-cy="63" transform="translate(200,63)">
      ...
      <g data-node-id="wt-node-verify" className="node-group ntype-action" data-cx="430" data-cy="63" transform="translate(430,63)">
      ...
      <g data-node-id="wt-node-assess" className="node-group ntype-action" data-cx="490" data-cy="187" transform="translate(490,187)">
      ...
      <g data-node-id="wt-node-priority" className="node-group ntype-switch" data-cx="660" data-cy="187" transform="translate(660,187)">
      ...
      <g data-node-id="wt-node-emergprep" className="node-group ntype-action" data-cx="600" data-cy="325" transform="translate(600,325)">
        <rect className="node-rect" x="-40" y="-15" width="80" height="30" style={{ stroke: 'rgba(255,146,67,0.3)' }}/>
        <text className="node-type-badge" x="0" y="-6" fill="#FF9243">ACTION</text>
        <text className="node-label" x="0" y="6">Emergency Prep</text>
      </g>
      {/* Doctor Review (action) */}
      <g data-node-id="wt-node-review" className="node-group ntype-action" data-cx="310" data-cy="325" transform="translate(310,325)">
        <rect className="node-rect" x="-40" y="-15" width="80" height="30" style={{ stroke: 'rgba(255,146,67,0.3)' }}/>
        <text className="node-type-badge" x="0" y="-6" fill="#FF9243">ACTION</text>
        <text className="node-label" x="0" y="6">Doctor Review</text>
      </g>
      {/* Schedule Appointment (action) */}
      <g data-node-id="wt-node-schedule" className="node-group ntype-action" data-cx="780" data-cy="375" transform="translate(780,375)">
      ...
      {/* End (terminal) */}
      <g data-node-id="wt-node-end" className="node-group ntype-terminal" data-cx="130" data-cy="325" transform="translate(130,325)">
