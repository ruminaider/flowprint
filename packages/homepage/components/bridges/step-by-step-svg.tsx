...
export interface StepByStepSvgProps {
  isActive: boolean
  sbRipples: RippleObj[]
}

export function StepByStepSvg({ isActive, sbRipples }: StepByStepSvgProps) {
  return (
    <svg className={`flow-svg${isActive ? ' active-svg' : ''}`} viewBox="0 0 900 400" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ALL edges */}
      <line data-edge-id="sb-edge-submit-upload" className="edge" x1="245" y1="58" x2="385" y2="58" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-upload-credit" className="edge" x1="430" y1="73" x2="430" y2="167" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-credit-risk" className="edge" x1="468" y1="182" x2="600" y2="182" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-risk-approved-v" className="edge" x1="640" y1="197" x2="640" y2="305" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-risk-denied-h" className="edge" x1="680" y1="182" x2="780" y2="182"/>
      <line data-edge-id="sb-edge-risk-denied-v" className="edge" x1="780" y1="182" x2="780" y2="305" markerEnd="url(#sb-arrow)"/>
      <path data-edge-id="sb-edge-risk-review-h" className="edge" d="M600 197 L480 250 L340 250"/>
      <line data-edge-id="sb-edge-risk-review-v" className="edge" x1="340" y1="250" x2="340" y2="305" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-offer-disburse" className="edge" x1="640" y1="335" x2="560" y2="365" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-disburse-end" className="edge" x1="517" y1="380" x2="173" y2="380" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-reject-end-h" className="edge" x1="780" y1="335" x2="780" y2="380"/>
      <line data-edge-id="sb-edge-reject-end-v" className="edge" x1="780" y1="380" x2="173" y2="380" markerEnd="url(#sb-arrow)"/>
      <path data-edge-id="sb-edge-manual-risk-v" className="edge" d="M300 305 L300 155 L640 155 L640 167" markerEnd="url(#sb-arrow)"/>
      <line data-edge-id="sb-edge-manual-risk-h" className="edge" x1="0" y1="0" x2="0" y2="0" style={{ opacity: 0 }}/>
      ...
      <g data-node-id="sb-node-submit" className="node-group ntype-action" data-cx="200" data-cy="58" transform="translate(200,58)">
      ...
      <g data-node-id="sb-node-upload" className="node-group ntype-action" data-cx="430" data-cy="58" transform="translate(430,58)">
        <rect className="node-rect" x="-45" y="-15" width="90" height="30" style={{ stroke: 'rgba(255,146,67,0.3)' }}/>
        <text className="node-type-badge" x="0" y="-6" fill="#FF9243">ACTION</text>
        <text className="node-label" x="0" y="6">Upload Documents</text>
      </g>
      {/* Credit Check (action) */}
      <g data-node-id="sb-node-credit" className="node-group ntype-action" data-cx="430" data-cy="182" transform="translate(430,182)">
      ...
      <g data-node-id="sb-node-risk" className="node-group ntype-switch" data-cx="640" data-cy="182" transform="translate(640,182)">
      ...
      <g data-node-id="sb-node-offer" className="node-group ntype-action" data-cx="640" data-cy="320" transform="translate(640,320)">
      ...
      <g data-node-id="sb-node-disburse" className="node-group ntype-action" data-cx="560" data-cy="380" transform="translate(560,380)">
      ...
      <g data-node-id="sb-node-reject" className="node-group ntype-action" data-cx="780" data-cy="320" transform="translate(780,320)">
        <rect className="node-rect" x="-40" y="-15" width="80" height="30" style={{ stroke: 'rgba(255,146,67,0.3)' }}/>
        <text className="node-type-badge" x="0" y="-6" fill="#FF9243">ACTION</text>
        <text className="node-label" x="0" y="6">Send Rejection</text>
      </g>
      {/* Manual Review (action) */}
      <g data-node-id="sb-node-manual" className="node-group ntype-action" data-cx="340" data-cy="320" transform="translate(340,320)">
        <rect className="node-rect" x="-40" y="-15" width="80" height="30" style={{ stroke: 'rgba(255,146,67,0.3)' }}/>
        <text className="node-type-badge" x="0" y="-6" fill="#FF9243">ACTION</text>
        <text className="node-label" x="0" y="6">Manual Review</text>
      </g>
      {/* End (terminal) */}
      <g data-node-id="sb-node-end" className="node-group ntype-terminal" data-cx="160" data-cy="380" transform="translate(160,380)">
      ...
      <g data-tooltip-id="tt-sb-submit" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-upload" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-credit" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-risk" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-offer" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-disburse" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-reject" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-manual" className="data-tooltip">
      ...
      <g data-tooltip-id="tt-sb-end" className="data-tooltip">
